    ...
    <?php if (get_theme_mod('advance_training_academy_show_hide_copyright', true)) {?>
      <div class="container">
        <div class="copyright p-3 text-center">
          <p class="mb-0"><?php advance_training_academy_credit();?><?php echo esc_html(get_theme_mod('advance_training_academy_footer_copy', __('By Themeshopy', 'advance-training-academy')));?></p>
        </div>
      </div>
    <?php }?>
  </div>
