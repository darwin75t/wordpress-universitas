...
<?php
 $advance_training_academy_shop_page_sidebar = get_theme_mod( 'advance_training_academy_shop_page_sidebar',true );
 if ( false == $advance_training_academy_shop_page_sidebar ) {
...
<div class="container">
	<main role="main" id="maincontent" class="py-5">
		<div class="row m-0">
			...
			<?php if ( false != $advance_training_academy_shop_page_sidebar ) {?>
