...
if ( ! class_exists( 'Advance_Training_Academy_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class Advance_Training_Academy_WPTT_WebFont_Loader {
...
if ( ! function_exists( 'wptt_get_webfont_styles' ) ) {
	...
	function wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new Advance_Training_Academy_WPTT_WebFont_Loader( $url );
