...
if($elearning_education_tp_secoundary_color_option != false){
$elearning_education_tp_theme_css .=' a:hover, .headerbox i,.main-navigation .current_page_item > a, .main-navigation .current-menu-item > a,.main-navigation a:hover,.more-btn a, #online-courses h2,.readmore-btn a:hover {';
