...
$elearning_education_menu_font_size = get_theme_mod('elearning_education_menu_font_size', 15);{
...
$elearning_education_menu_text_tranform = get_theme_mod( 'elearning_education_menu_text_tranform','Uppercase');
...
$elearning_education_slider_content_layout = get_theme_mod('elearning_education_slider_content_layout', 'CENTER-ALIGN'); 
